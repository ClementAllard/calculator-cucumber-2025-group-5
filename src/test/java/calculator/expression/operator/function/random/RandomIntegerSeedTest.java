...
class RandomIntegerSeedTest {
    ...
    @Test
    void testRandomIntegerSeedWithRationalBase(){
        try {
    ...
    @Test
    void testRandomIntegerSeedWithRealBase(){
        try {
            ...
            expression = new RandomIntegerSeed(args);
            assertEquals("6", calculator.eval(expression));

            args = Arrays.asList(myReal, myComplex);
            expression = new RandomIntegerSeed(args);
            assertEquals("7", calculator.eval(expression));
        } catch (Exception e) {
            fail(e.getMessage());
        }
    }
    ...
    @Test
    void testRandomIntegerSeedWithComplexBase(){
        try {
    ...
    @Test
    void testRandomIntegerSeedErrorCases(){
