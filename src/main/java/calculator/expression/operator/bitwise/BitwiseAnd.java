...
public final class BitwiseAnd extends BinaryLogicOperation {
     ...
     * @see #BitwiseAnd(List<Expression>, Notation)
     */
    public /*constructor*/ BitwiseAnd(List<Expression> elist) throws IllegalConstruction {
        this(elist, null);
    }
     ...
     * @throws IllegalConstruction If an empty list of expressions if passed as parameter
     * @see #BitwiseAnd(List<Expression>)
     */
    public BitwiseAnd(List<Expression> elist, Notation n) throws IllegalConstruction {
        super(elist, n);
        if (elist.isEmpty()) {
